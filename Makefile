#############################################################################
# Makefile for building: bzLinux
# Generated by qmake (2.01a) (Qt 4.8.5) on: Thu Jun 10 14:31:10 2021
# Project:  bzLinux.pro
# Template: app
# Command: /usr/local/Trolltech/QtEmbedded-4.8.5-arm/bin/qmake -spec /usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/qws/linux-arm-g++ CONFIG+=debug -o Makefile bzLinux.pro
#############################################################################
...
DIST          = /usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/common/unix.conf \
		...
		/usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/features/debug.prf \
...
Makefile: bzLinux.pro  /usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/qws/linux-arm-g++/qmake.conf /usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/common/unix.conf \
		/usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/common/linux.conf \
		/usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Trolltech/QtEmbedded-4.8.5-arm/mkspecs/qws/linux-arm-g++ CONFIG+=debug -o Makefile bzLinux.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/bzLinux1.0.0 || $(MKDIR) .tmp/bzLinux1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bzLinux1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/bzLinux1.0.0/ && $(COPY_FILE) --parents res.qrc .tmp/bzLinux1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/bzLinux1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/bzLinux1.0.0/ && (cd `dirname .tmp/bzLinux1.0.0` && $(TAR) bzLinux1.0.0.tar bzLinux1.0.0 && $(COMPRESS) bzLinux1.0.0.tar) && $(MOVE) `dirname .tmp/bzLinux1.0.0`/bzLinux1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bzLinux1.0.0
...
qrc_res.cpp: res.qrc \
		...
		image/fj2.jpg \
		image/zy.jpg
	/usr/local/Trolltech/QtEmbedded-4.8.5-arm/bin/rcc -name res res.qrc -o qrc_res.cpp
